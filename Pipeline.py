...
class Pipeline:
    ...
    def __init__(self):
        ...
        """
        self.__source0 = None
        self.__hsv_threshold_input = self.__source0
        self.__hsv_threshold_hue = [27.51798561151079, 89.38566552901025]
        self.__hsv_threshold_saturation = [82.55395683453239, 255.0]
